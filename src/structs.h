...
int     dream_karma;
      ...
      int                 renames;
      int                 colours;
      int                 recolor_month; // Last credited real UTC calendar month.
      int                 bandaids;
      
      int     pkarmaspent;
      int     pkarma_remainder; /* Unconverted raw personal karma reward. */
      int     daily_pvp_exp;
    ...
    struct location_type
    {
      ...
      int   territory_bonus;
      int   territory_bonus_secondary;
      int   reward_footholds[3];
      int   reward_controller; // -1 initializes old saves without a capture payout.
      int   status;
      int   continent;
      int   hand;
      int   order;
      ...
      int   lockout;
      int   phil_amount[TERRITORY_SUPPORT_SLOTS];
      ...
      char *  base_society_desc;
      int   base_society;
       char *  base_society_secondary_desc;
      int   base_society_secondary;
    ...
    // Viewer-relative objective coordinates, scoped to one map draw.
    struct OperationPoiPosition {
      int x, y, type;
    };
...
int lastused;
    ...
    {
      char *      author;
      int         professional_focus; // Author's focus at launch; -1 for legacy saves.
      int         socialite_bonus; // Socialite roll bonus at launch; -1 for legacy saves.
      int         launch_cost; // Influence actually paid; 0 for legacy saves.
      int         thwart_cooldown; // Shared next-attempt timestamp.
    ...
    */
    ...
    struct domain_type
    {
     ...
     char * ambients;
     int archetype;
     int claimed_territory;
     int successful_worships;
     long banished_until;
     bool guest_retired;
     int power;
     int exp;
    ...
    struct faction_type
    {
      ...
      char *power_worships;
      char *power_opposes;
      int patron_relation; // Optional society relationship; independent of type.
      ...
      int   lf_quota_month;
      int   lf_quota_harvested;
      int   last_dissent; // Real-time start; persists the global seven-day cooldown.
      ...
      int strategic_alliance; // Core deployment affiliation stays in alliance.
      char *recovery_receipts;
      int   resource;
      int   research;
      int   battlehour;
      int   battleday;
    ...
    */
    struct  pc_data
    {
      ...
      char *    last_name;
      char *    verbal_color;
      int       who_name_color; // 0: default, 1..256: xterm 0..255.
      int       emote_say_color;
      ...
      int     ftype;
      bool    society_created; // Lifetime creation limit, independent of membership.
...
bool	crowded_room;
      ...
      int     ill_count;
      int     ill_time;
      long    cauterize_until;
      int     mind_guarded;
      int     mind_guard_mult;
      int     branddate;
      bool    cortex_human_brand;
      int     brandlocation;
      int     brandstatus;
      int     default_speed;
      int     brandcool;
      ...
      int     guest_type;
      int     guest_tier;
      int     earned_guest_tier;
      int     guest_reward_used;
      int     monster_reward_hours;
      long    population_last_active;
      char *    dream_origin;
      char *    speaking;
    ...
    char *              photo_msgs;
      ...
      */
      ...
      int operative_creation_faction;
      char * operative_core;
      char * operative_legacy_society;
      char * operative_society;
    ...
    */
    struct  room_index_data
    {
      ...
      bool      description_decorated; // Decorate owns prose and place choices.
