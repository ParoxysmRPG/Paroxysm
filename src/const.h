...
#define PERSONAL_KARMA_CAP 50000
#define PERSONAL_KARMA_BAND 10000

/* Preserve these systems and their data for future development. */
#define ENCOUNTERS_ENABLED 0
#define STORY_IDEAS_ENABLED 0
...
#define RACE_CIVIL_SERVANT       9
#define RACE_DEPUTY              RACE_CIVIL_SERVANT // Legacy source compatibility.
...
#define ACT_NONE		    41
#define ACT_CORTEX_BREACH       42
#define ACT_CORTEX_ENFORCER     43
...
//#define DEV_PORT
    ...
    // Runtime objects and prototypes share the six-value persistence format.
    #define MAX_OBJ_VALUES         6
    #define MARKET_FILE		    "../data/market.txt"
    #define OPERATION_FILE	    "../data/operations.txt"
...
#define SKILL_CCORTEX			186
#define SKILL_CORDER			187
#define SKILL_CSCUM			188
...
#define FACTION_CORTEX		5
#define FACTION_ORDER		6
#define FACTION_SCUM		7


#define FACTION_CORE		1
#define FACTION_NPC			2
#define FACTION_SOCIETY 3
#define SOCIETY_PATRON_NONE 0
#define SOCIETY_PATRON_WORSHIP 1
#define SOCIETY_PATRON_OPPOSE 2
...
#define CORTEX_LT              101
#define ORDER_LT             103
#define SCUM_LT                 109

#define CORTEX_SOLDIER         100
#define ORDER_SOLDIER        102
#define SCUM_SOLDIER            108
...
#define DEFAULT_MAXEXP		3000000
#define DEFAULT_MAXRPEXP	3000000
...
#define CONTACT_CORTEX		7
#define CONTACT_ORDER		8
#define CONTACT_SCUM		9
...
#define GUEST_HIGHERPOWER 9
#define GUEST_REMAKE 10
...
#define GOAL_WORSHIP 17
#define GOAL_ATTACK_POWER 18
...
// Zero remains the legacy "unset" position.
#define AXES_DEMONIC -1
...
// Persisted territory reward IDs; append new rewards rather than renumbering.
enum TerritoryBonus {
  TERRITORY_WELL_FED = 1, TERRITORY_LANDLORD, TERRITORY_BEACH_BOD,
  TERRITORY_PAYROLL, TERRITORY_ARISTOCRACY, TERRITORY_FREE_MARKET,
  TERRITORY_FREE_LEASE, TERRITORY_SEMPER_FI, TERRITORY_AMMO,
  TERRITORY_KNOCK_KNOCK, TERRITORY_HALO, TERRITORY_PANHANDLER,
  TERRITORY_IMPORT_EXPORT, TERRITORY_SEA_KISS, TERRITORY_WITCH,
  TERRITORY_FEYWOOD, TERRITORY_DARKWOOD,
  TERRITORY_CITY_HALL,
  TERRITORY_IVY_LEAGUE,
  TERRITORY_HOUSE_RULES,
  TERRITORY_PUBLICIST,
  TERRITORY_THIN_AIR,
  TERRITORY_COURT_CONNECTIONS,
  TERRITORY_OLD_STORIES,
  TERRITORY_HAUTE_COUTURE,
  TERRITORY_FANCY_FOOTWORK,
  TERRITORY_PRECISION_ENGINEERING,
  TERRITORY_BEAUTY_SECRETS,
  TERRITORY_ANCIENT_RITES,
  TERRITORY_KNOW_ENEMY,
  TERRITORY_HOLD_LINE,
  TERRITORY_MIDNIGHT_SOCIETY,
  TERRITORY_MAKE_DO,
  TERRITORY_PAPER_TRAIL,
  TERRITORY_PRIVATE_SECURITY,
  TERRITORY_ART_PATRON,
  TERRITORY_HORSE_WHISPERER,
  TERRITORY_TRIPLE_THREAT,
  TERRITORY_BACK_ALLEY,
  TERRITORY_ROOT_ACCESS,
  TERRITORY_SACRED_CHARMS,
  TERRITORY_SPLIT_SECOND,
  TERRITORY_LIGHT_FINGERS,
  TERRITORY_FIRST_RESPONDER,
  TERRITORY_ANOTHER_MUSE,
  TERRITORY_HEAVY_LIFTING,
  TERRITORY_LONG_STRIDE,
  TERRITORY_HEAD_DOWN,
  TERRITORY_ALCHEMIST_MARKET,
  TERRITORY_ANCESTRAL_TRAINING,
  TERRITORY_CLEAN_GETAWAY,
  TERRITORY_FIRING_RANGE,
  TERRITORY_VEILED_STEPS,
  TERRITORY_EXTRA_HANDS,
  TERRITORY_LOCAL_CONNECTIONS,
  TERRITORY_THWART_ATTACK,
  TERRITORY_THWART_DEFENSE,
  TERRITORY_THWART_DISCOUNT,
  TERRITORY_INVESTIGATE_ATTACK,
  TERRITORY_INVESTIGATE_DEFENSE,
  TERRITORY_FREE_INVESTIGATION,
  TERRITORY_SCHEME_DISCOUNT,
  TERRITORY_BOUGHT_TIME,
  TERRITORY_BONUS_COUNT
};
