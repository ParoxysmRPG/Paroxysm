"""Run full-moon integration checks against the engine in a disposable world."""
...
with tempfile.TemporaryDirectory(prefix='haven-full-moon-') as temporary:
    ...
    # The checked-in Wilds forest is truncated midway through a room. Use its
    # complete backup only in this disposable fixture; do not alter live areas.
