...
with tempfile.TemporaryDirectory(prefix="haven-syndicate-test-") as temporary:
    ...
    subprocess.run(["g++", "-g", "-Wno-deprecated", "-Wno-write-strings", *flags,
                    "-I" + str(ROOT / "src"), str(ROOT / "tools/test_syndicate.cpp"),
    ...
    (build.parent / "syndicate-test.log").write_text(result.stdout)
