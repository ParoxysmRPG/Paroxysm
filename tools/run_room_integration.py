#!/usr/bin/env python3
"""Run under Linux/WSL after make. Boot a disposable copy, never the live data."""
...
shutil.copy2(ROOT/'src'/'comm.o', comm)
...
objects = [str(ROOT/'src'/name) for name in re.findall(r'[\w-]+\.o\b', object_list) if name != 'comm.o']
