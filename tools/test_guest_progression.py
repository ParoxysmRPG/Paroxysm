...
with tempfile.TemporaryDirectory(prefix="haven-guest-test-") as temporary:
    ...
    subprocess.run(["g++", "-g", "-Wno-deprecated", "-Wno-write-strings", *flags,
                    "-I" + str(ROOT / "src"), str(ROOT / "tools/test_guest_progression.cpp"),
    ...
    (build.parent / "guest-test.log").write_text(result.stdout)
